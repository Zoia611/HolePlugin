...
namespace HolePlugin
{
    ...
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        {
            TaskDialog.Show("Ошибка", "Не найдено семейства \"Отверстие"\");
            return Result.Cancelled;
        }
        ...
        if (view3D == null)
        {
            TaskDialog.Show("Ошибка", "Не найден вид");
            return Result.Cancelled;
        }
        ...
        transaction0.Start("Активация семейства");
    ...
    public class ReferenceWithContextElementEqualityComparer : IEqualityComparer<ReferenceWithContext>
    {
        ...
        public int GetHashCode(ReferenceWithContext obj)
        {
            ...
            unchecked
            {
                return (reference.LinkedElementId.GetHashCode() * 297) ^ reference.ElementId.GetHashCode();
            }
        }
    }
}
